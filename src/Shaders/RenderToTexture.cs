...
namespace GoblinXNA.Shaders
{
    ...
    /// </summary>
    internal class RenderToTexture : Texture
    {
        #region Variables
        /// <summary>
        ...
        private void CalcSize()
        {
            switch (sizeType)
            {
                case SizeType.FullScreen:
                    ...
                    texHeight = State.Height;
                    break;
                case SizeType.HalfScreen:
                    texWidth = State.Width / 2;
                    texHeight = State.Height / 2;
                    break;
                case SizeType.QuarterScreen:
                    texWidth = State.Width / 4;
                    texHeight = State.Height / 4;
                    break;
        ...
        public RenderToTexture(SizeType setSizeType)
        {
            ...
            State.AddRemRenderToTexture(this);
        }
        #endregion
        ...
        {
            //    return State.Device.CreationParameters.Adapter.CheckDeviceFormat(
            //        State.Device.CreationParameters.DeviceType,
            //        State.Device.DisplayMode.Format,
            //        ResourceUsage.None,
            //        QueryUsages.None,
        ...
        private void Create()
        {
            ...
            if (State.Device.PresentationParameters.BackBufferHeight == 720)
            {
            ...
            if (sizeType == SizeType.ShadowMap &&
                (texWidth > State.Width || texHeight > State.Height))
            {
                zBufferSurface =
                    ...
                    State.Graphics.PreferredDepthStencilFormat,
